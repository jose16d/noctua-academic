...
' Abre la aplicación en una ventana nativa de escritorio independiente
' ============================================================================
...
' 1. Iniciar el servidor Express en segundo plano (oculto, 0 = ocultar ventana)
WshShell.Run "node server.js", 0, False

' 2. Esperar 1 segundo a que SQLite y Express inicien
WScript.Sleep 1200

' 3. Buscar navegador compatible para modo App Nativo (Edge o Chrome)
...
' 4. Abrir la ventana de la aplicación
